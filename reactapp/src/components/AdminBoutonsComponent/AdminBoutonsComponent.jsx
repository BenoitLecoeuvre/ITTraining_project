...
const AdminBoutonsComponent = ({ contact, setContact, addFormation, setAddFormation, displayFormation, setDisplayFormation, todoList, setTodoList, history, setHistory }) => {
    ...
    return (
        <div className='admin_buttons'>
            ...
            <div className='button_div'>
                <button type="button" className='admin_button admin_display' onClick={() => setDisplayFormation(!displayFormation)}>
            ...
            <div className='button_div'>
                <button type="button" className='admin_button admin_todo' onClick={() => setTodoList(!todoList)}>
            ...
            <div className='button_div'>
                <button type="button" className='admin_button admin_formhistory' onClick={() => setHistory(!history)}>
            ...
            <div className='button_div'>
                <button type="button" className='admin_button admin_contacthistory' onClick={() => setContact(!contact)}>
